auto_scale_lr = dict(base_batch_size=1)  # 16
backend_args = None
batch_augments = [
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            'checkpoints/swin/swin_large_patch4_window12_384_22k.pth',
            type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            6,
...
pretrained = 'checkpoints/swin/swin_large_patch4_window12_384_22k.pth'
resume = False
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(img='valonesequence/'),
        data_root='/media/data2/TrackingDatasets/Anti-UAV410/Anti-UAV/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
test_evaluator = dict(
    _scope_='mmdet',
    ann_file='/media/data2/TrackingDatasets/Anti-UAV410/Anti-UAV/annotations/valonesequence.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = './work_dirs/co_dino_5scale_swin_l_16xb1_16e_o365tococo'
